...
|---|---|---|---|---|---|
| `map_matched_osrm_constant_velocity_dr` | 58 | 252.1 | 168.3 | 494.0 | 31% |
| `hmm_matched_osrm_constant_velocity_dr` | 58 | 252.1 | 168.3 | 494.0 | 31% |
...
| `map_matched_osrm_ins_dr` | 58 | 264.6 | 202.7 | 600.0 | 29% |
| `hmm_matched_osrm_ins_dr` | 58 | 264.6 | 202.7 | 600.0 | 29% |
...
| `hmm_matched_osrm_model` | 58 | 415.1 | 360.5 | 716.9 | 12% |
| `map_matched_osrm_model` | 58 | 415.1 | 360.5 | 716.9 | 12% |
| `map_matched_graph_model_speed_fused` | 58 | 501.6 | 516.3 | 867.2 | 10% |
| `hmm_matched_graph_model_speed_fused` | 58 | 501.6 | 516.3 | 867.2 | 10% |
| `hmm_matched_osrm_model_speed_fused` | 58 | 501.6 | 516.3 | 867.1 | 10% |
| `map_matched_osrm_model_speed_fused` | 58 | 501.6 | 516.3 | 867.1 | 10% |
...
| `hmm_matched_osrm_constant_velocity_dr` | 12.2 | 46.8 | 122.0 |
| `hmm_matched_osrm_ins_dr` | 25.2 | 84.4 | 189.3 |
| `hmm_matched_osrm_model` | 59.9 | 168.2 | 324.2 |
| `hmm_matched_osrm_model_speed_fused` | 63.6 | 188.0 | 372.9 |
...
| `map_matched_osrm_constant_velocity_dr` | 12.2 | 46.8 | 122.0 |
| `map_matched_osrm_ins_dr` | 25.2 | 84.4 | 189.3 |
| `map_matched_osrm_model` | 59.9 | 168.2 | 324.2 |
| `map_matched_osrm_model_speed_fused` | 63.6 | 188.0 | 372.9 |
...
| `hmm_matched_osrm_constant_velocity_dr` | 6.6 | 19.4 | 46.1 |
| `hmm_matched_osrm_ins_dr` | 24.1 | 74.1 | 152.9 |
| `hmm_matched_osrm_model` | 47.5 | 129.3 | 247.6 |
| `hmm_matched_osrm_model_speed_fused` | 51.7 | 145.4 | 278.0 |
...
| `map_matched_osrm_constant_velocity_dr` | 6.6 | 19.4 | 46.1 |
| `map_matched_osrm_ins_dr` | 24.1 | 74.1 | 152.9 |
| `map_matched_osrm_model` | 47.5 | 129.3 | 247.6 |
| `map_matched_osrm_model_speed_fused` | 51.7 | 145.4 | 278.0 |
...
| `hmm_matched_osrm_constant_velocity_dr` | 3731 | 478 | 4209 |
| `hmm_matched_osrm_ins_dr` | 3731 | 478 | 4209 |
| `hmm_matched_osrm_model` | 3731 | 478 | 4209 |
| `hmm_matched_osrm_model_speed_fused` | 3731 | 478 | 4209 |
...
| `map_matched_osrm_constant_velocity_dr` | 3731 | 478 | 4209 |
| `map_matched_osrm_ins_dr` | 3731 | 478 | 4209 |
| `map_matched_osrm_model` | 3731 | 478 | 4209 |
| `map_matched_osrm_model_speed_fused` | 3731 | 478 | 4209 |
| `model` | 3752 | 457 | 4209 |
...
| `hmm_matched_osrm_constant_velocity_dr` | 3731 | 3817 | 2338 | 7463 | 6764 | 699 | 21 | 0 |
| `hmm_matched_osrm_ins_dr` | 3731 | 3428 | 2132 | 7463 | 6776 | 687 | 21 | 0 |
| `hmm_matched_osrm_model` | 3731 | 4326 | 2647 | 7463 | 6780 | 683 | 21 | 0 |
| `hmm_matched_osrm_model_speed_fused` | 3731 | 4442 | 2666 | 7463 | 6799 | 664 | 21 | 0 |
...
| `map_matched_osrm_constant_velocity_dr` | 3731 | 3802 | 2338 | 7463 | 6764 | 699 | 21 | 0 |
| `map_matched_osrm_ins_dr` | 3731 | 3423 | 2131 | 7463 | 6775 | 688 | 21 | 0 |
| `map_matched_osrm_model` | 3731 | 4291 | 2641 | 7463 | 6780 | 683 | 21 | 0 |
| `map_matched_osrm_model_speed_fused` | 3731 | 4402 | 2661 | 7463 | 6799 | 664 | 21 | 0 |
...
hmm_matched_graph_constant_velocity_dr        60.0  414        125.83           46.59       327.03      2392.73        7.62          100.67
 ...
 hmm_matched_osrm_constant_velocity_dr        10.0 2486         12.19            6.59        27.57       315.17       -0.11            9.92
 hmm_matched_osrm_constant_velocity_dr        30.0  831         46.81           19.43       106.29      1241.69        1.69           37.34
 hmm_matched_osrm_constant_velocity_dr        60.0  414        121.98           46.06       324.24      2392.80        7.62          100.68
               hmm_matched_osrm_ins_dr        10.0 2486         25.24           24.07        39.31       307.46      -21.61           24.06
               hmm_matched_osrm_ins_dr        30.0  831         84.35           74.10       130.88      1174.29      -60.73           77.52
               hmm_matched_osrm_ins_dr        60.0  414        189.29          152.95       310.91      2231.73     -113.09          170.16
                hmm_matched_osrm_model        10.0 2486         59.90           47.54       134.35       300.37       17.90           59.02
                hmm_matched_osrm_model        30.0  831        168.21          129.27       394.50      1030.86       58.25          161.21
                hmm_matched_osrm_model        60.0  414        324.21          247.56       745.53      1852.64      119.82          301.69
    hmm_matched_osrm_model_speed_fused        10.0 2486         63.56           51.72       134.99       325.15       17.89           62.59
    hmm_matched_osrm_model_speed_fused        30.0  831        188.02          145.39       425.54      1267.66       60.76          182.33
    hmm_matched_osrm_model_speed_fused        60.0  414        372.92          278.04       822.23      2393.70      126.16          353.43
...
map_matched_graph_constant_velocity_dr        60.0  414        119.64           45.57       318.67      2392.73        7.64          100.69
 ...
 map_matched_osrm_constant_velocity_dr        10.0 2486         12.19            6.59        27.57       315.17       -0.11            9.92
 map_matched_osrm_constant_velocity_dr        30.0  831         46.81           19.43       106.29      1241.69        1.69           37.34
 map_matched_osrm_constant_velocity_dr        60.0  414        121.98           46.06       324.24      2392.80        7.62          100.68
               map_matched_osrm_ins_dr        10.0 2486         25.24           24.07        39.31       307.46      -21.61           24.06
               map_matched_osrm_ins_dr        30.0  831         84.35           74.10       130.88      1174.29      -60.73           77.52
               map_matched_osrm_ins_dr        60.0  414        189.29          152.95       310.91      2231.73     -113.09          170.16
                map_matched_osrm_model        10.0 2486         59.90           47.54       134.35       300.37       17.90           59.02
                map_matched_osrm_model        30.0  831        168.21          129.27       394.50      1030.86       58.25          161.21
                map_matched_osrm_model        60.0  414        324.21          247.56       745.53      1852.64      119.82          301.69
    map_matched_osrm_model_speed_fused        10.0 2486         63.56           51.72       134.99       325.15       17.89           62.59
    map_matched_osrm_model_speed_fused        30.0  831        188.02          145.39       425.54      1267.66       60.76          182.33
    map_matched_osrm_model_speed_fused        60.0  414        372.92          278.04       822.23      2393.70      126.16          353.43
